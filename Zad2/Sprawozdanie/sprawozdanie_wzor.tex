...
\subsection{Eksperyment nr 1 - Funkcja Sinus}

W pierwszym eksperymencie analizujemy Funkcję sinus. Wykonalismy próbkowanie na wygenerowanej funkcji a następnie dokonaliśmy rekonstrukcji sygnału każdą z metod.
...
\begin{table}[h!]
\caption{Wyniki obliczonych miar podobieństwa sygnałów dla rekonstrukcji zpróbkowanego sygnału funkcji sinusoidalnej}
\centering
\vspace{0.1cm}
