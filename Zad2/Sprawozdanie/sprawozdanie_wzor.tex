...
\begin{table}[h!]
\caption{Miary podobieństwa sygnału sinusoidalnego i rekonstrukcji metodą ekstrapolacji zerowego rzędu }
\centering
\vspace{0.1cm}
 \begin{tabular}{c c c c c}
    \textbf{MSE} & \textbf{SNR}   & \textbf{PSNR}  & \textbf{MD} & \textbf{ENOB} \\
\hline
0,009 & 17,506 & 20,517 & 0,203 & 2,616\\
\end {tabular}
\label {Miary podobieństwa pierwszego sygnału pierwszej rekonstrukcji }
\end{table}
...
\begin{figure}[h!]
 ...
 \vspace{-0.3cm}
 \caption{Wykres sygnału funkcji sinusoidalenj po próbkowaniu i następnym zrekonstruowaniu metodą interpolacji pierwszego rzędu.}
 \label{rysunek do eksperymentu 1 wariantu 4}
\end{figure}

\begin{table}[h!]
\caption{Miary podobieństwa sygnału sinusoidalnego i rekonstrukcji metodą interpolacji pierwszego rzędu. }
\centering
\vspace{0.1cm}
 \begin{tabular}{c c c c c}
    \textbf{MSE} & \textbf{SNR}   & \textbf{PSNR}  & \textbf{MD} & \textbf{ENOB} \\
\hline
0.000 & 44.178 & 47.189 & 0.008 & 7.046\\
\end {tabular}
\label {Miary podobieństwa pierwszego sygnału drugiej rekonstrukcji }
\end{table}
\newpage
...
\begin{table}[h!]
\caption{Miary podobieństwa sygnału sinusoidalnego i rekonstrukcji w oparciu o funkcję sinc. }
\centering
\vspace{0.1cm}
 \begin{tabular}{c c c c c}
    \textbf{MSE} & \textbf{SNR}   & \textbf{PSNR}  & \textbf{MD} & \textbf{ENOB} \\
\hline
0.000 & 42.841 & 45.851 & 0.023 & 6.824\\
\end {tabular}
\label {Miary podobieństwa pierwszego sygnału trzeciej rekonstrukcji }
\end{table}
\newpage
...
\subsection{Eksperyment nr 3 - Sygnał prostokątny próbkowanie}
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=14cm]{exp_1_prost_prob.png}
 \vspace{-0.3cm}
 \caption{Wykres sygnału po wykonaniu próbkowania }
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=14cm]{exp_2_prost_rek_1.png}
 \vspace{-0.3cm}
 \caption{Wykres sygnału funkcji prostokątnej po próbkowaniu i następnym zrekonstruowaniu metodą ekstrapolacji zerowego rzędu.}
 \label{rysunek do eksperymentu 1 wariantu 3}
\end{figure}

\begin{table}[h!]
\caption{Miary podobieństwa sygnału prostokątnego i rekonstrukcji metodą ekstrapolacji zerowego rzędu }
\centering
\vspace{0.1cm}
 \begin{tabular}{c c c c c}
    \textbf{MSE} & \textbf{SNR}   & \textbf{PSNR}  & \textbf{MD} & \textbf{ENOB} \\
\hline
0,004 & 21,249 & 24,260 & 0,0 & 3,237\\
\end {tabular}
\label {Miary podobieństwa drugiego sygnału pierwszej rekonstrukcji }
\end{table}
